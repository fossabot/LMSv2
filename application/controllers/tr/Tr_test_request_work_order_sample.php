...
class tr_test_request_work_order_sample extends controllerBasicExtend {
    ...
    public function index() {
        ...
        $fixed = array(
            array('desc' => '1000', 'sql' => ' 1000', 'default' => 'Y'),
            array('desc' => '2000', 'sql' => '2000'),
            array('desc' => '5000', 'sql' => '5000')
        );
        ...
        $fm->addFilter('filter_test', 'Type', array('controller' => 'tr/test_type', 'fieldname' => '"PROJECT_BUILD_SCHEDULE_TESTS".cd_test_type', 'multi' => true));
        ...
        $grid->addColumn('ds_test_type', 'Type', '80px', $f->retTypeStringAny(), false);
