...
<style>
    /*Rest*/
    .legData {width: 80px;display: inline-block;text-align: center;height: 20px;padding-top: 3px;vertical-align: center;border: 1px solid gray};
...
<?php echo ($javascript); ?>
        ...
        this.makeToolbarLegend = function () {
            ...
            w2ui[thisObj.gridName].toolbar.insert('export', [{type: 'html', id: 'leg', html: html}]);
