...
<html>
    <head>
        ...
        <!-- W2UI 
        <link rel="stylesheet" href="<?php echo base_url(); ?>plugins/w2ui1.5s/w2ui-1.5.rc1.min.css"/>
        <link rel="stylesheet" href="<?php echo base_url(); ?>plugins/w2ui-1.4.3/w2ui-1.4.3.bt.css?<?php echo ($timeStamp); ?>"/>
        -->

        <link rel=stylesheet href="<?php echo base_url(); ?>plugins/\jsGanttImproved/jsgantt.css" type="text/css">

        <link rel="stylesheet" href="<?php echo base_url(); ?>plugins/w2ui-1.4.3/w2ui-1.4.3.bt.css"/>

        <!--link rel="stylesheet" href="<?php echo base_url(); ?>plugins/w2ui-1.4.3/w2ui-1.4.3-addon.css"/-->
...
<?php echo ($config); ?>
        ...
        <!-- W2UI
        <script type="text/javascript" src="<?php echo base_url(); ?>plugins/w2ui1.5/w2ui-1.5.rc1.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>plugins/w2ui-1.4.3/w2ui-1.4.3.js"></script>
        -->
