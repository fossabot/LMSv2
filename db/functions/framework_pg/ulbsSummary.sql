...
BEGIN
    ...
    select distinct workorder_number::numeric(18,2)  as workorder_number, tool_number::integer as tool_number  
    FROM "ULBS"
    ...
    select max(a."ID") as id, a.fixture_id,  a.workorder_number::numeric(18,2) as workorder_number, a.tool_number::integer as tool_number  
    FROM "ULBS" a, ttMakeULBSWO t
    WHERE t.workorder_number   = a.workorder_number::numeric(18,2)
      AND t.tool_number        = a.tool_number::integer
    group by a.fixture_id,  a.workorder_number::numeric(18,2), a.tool_number::integer;
