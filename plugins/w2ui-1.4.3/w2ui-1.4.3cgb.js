    ...
    w2grid.prototype = {
        ...
        getSearchesHTML: function () {
            ...
            for (var i = 0; i < this.searches.length; i++) {
                ...
                var btn = '';
                if (showBtn == false) {
                    btn = '<button class="btn-w2ui close-btn" onclick="obj = w2ui[\''+ this.name +'\']; if (obj) { obj.searchClose(); }">X</button';
                    showBtn = true;
                }
            ...
            html += '<tr>'+
                    ...
                    '        <div>'+
                    '        <button class="btn-w2ui" onclick="obj = w2ui[\''+ this.name +'\']; if (obj) { obj.searchReset(); }">'+ w2utils.lang('Reset') + '</button>'+
                    '        <button class="btn-w2ui btn-blue" onclick="obj = w2ui[\''+ this.name +'\']; if (obj) { obj.search(); }">'+ w2utils.lang('Search') + '</button>'+
                    '        </div>'+
                    '    </td>'+
                    '</tr></table>';
            return html;
        ...
        generateHTML: function () {
            ...
            if (!$.isEmptyObject(this.actions)) {
                ...
                for (var a in this.actions) {
                    ...
                    buttons += '\n    <button name="'+ a +'" class="btn-w2ui '+ addClass +'">'+ w2utils.lang(a) +'</button>';
                }
                buttons += '\n</div>';
            }
